...
// Nếu bạn đã có loader Figma, dùng 2 dòng dưới. Nếu không, thay bằng URL ảnh.
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore
import myor2024Image from "figma:asset/bcf19e6ebda506c3f7d91e23099cd6d32cdbc2ed.png";
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore
import myor2025Image from "figma:asset/f39fd4af4eec1de1bafe1dc6d3e4574c52139dcf.png";

type Params = { params: { id: "myor-2025" | "myor-2024" | string } };

export default function Page({ params }: Params) {
  const { t } = useLocale();
  const competitionId = params.id as "myor-2025" | "myor-2024";
  ...
  const c = competitions[competitionId as keyof typeof competitions];
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto max-w-6xl px-4">
          <div className="grid items-center gap-8 md:grid-cols-2 md:gap-12">
            ...
            <div className="relative">
              <div className="aspect-[4/3] overflow-hidden rounded-3xl border-4 border-primary/20 shadow-2xl transition hover:scale-105">
                <img
                  src={c.image}
        ...
        <div className="container mx-auto max-w-6xl px-4">
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto max-w-2xl text-muted-foreground">
              {t("detail.cats.lead" /* fallback if not in DICTS */)}
            </p>
          </div>
      ...
      {/* Winners (2024) */}
      {competitionId === "myor-2024" &&
        (competitions["myor-2024"] as any).winners && (
          <section className="py-16 md:py-20">
            <div className="container mx-auto max-w-6xl px-4">
              <div className="mb-12 text-center">
                <h2 className="mb-3 text-3xl md:text-4xl">
              ...
              <div className="mb-12 grid gap-6 md:grid-cols-3">
                {(competitions["myor-2024"] as any).winners.map(
                  (
                    w: {
                      title: string;
                      names: string;
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary to-orange-500 p-8 text-white">
            ...
            <div className="relative z-10">
              <h3 className="mb-4 text-xl">
                🚀 {t("detail.cta.title" /* fallback */)} MYOR {c.year}?
              </h3>
